...
class handDetector():
    def __init__(self, image_mode=False, max_num_hands=3, min_detection_confidence=0.5, min_tracking_confidence=0.5):
        ...
        self.min_detection_confidence = float(min_detection_confidence)  # Explicitly cast to float
        self.min_tracking_confidence = float(min_tracking_confidence)  # Explicitly cast to float
